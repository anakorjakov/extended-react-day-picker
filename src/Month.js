...
export default class Month extends Component {
  static propTypes = {
    ...
    showExtraWeeksNext: PropTypes.number,
    showExtraWeeksPrev: PropTypes.number,
  ...
  render() {
    ...
    const weeks = Helpers.getWeekArray(month, firstDayOfWeek, fixedWeeks, showExtraWeeksNext, showExtraWeeksPrev);
    return (
